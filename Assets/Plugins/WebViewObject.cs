...
public class WebViewObject : MonoBehaviour
{
    ...
    public void ReSizetheMargins()
    {
        if (Screen.orientation == ScreenOrientation.LandscapeLeft || Screen.orientation == ScreenOrientation.LandscapeRight)
        {
#if UNITY_IPHONE
        _CWebViewPlugin_SetMargins(webView, 0, 0, 0, (int)(Screen.height * 0.12f), r);
#endif
#if UNITY_ANDROID
            webView.Call("SetMargins", 0, 0, 0, (int)(Screen.height * 0.12f));
#endif
        }
        ...
        {
#if UNITY_IPHONE
        _CWebViewPlugin_SetMargins(webView, 0, 0, 0, (int)(Screen.height * 0.06f), r);
#endif
#if UNITY_ANDROID
            webView.Call("SetMargins", 0, 0, 0, (int)(Screen.height * 0.06f));
#endif
        }
    }
    //Get keyboard Height for android return integer
...
#elif UNITY_IPHONE
        _CWebViewPlugin_SetMargins(webView, 0, 0, 0, (int)(Screen.height * 0.073f), r);
#elif UNITY_ANDROID
